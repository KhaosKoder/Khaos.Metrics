...
{
	[Fact]
	public void AddKhaosMetrics_RegistersCoreServices()
	{
		var services = new ServiceCollection();
		services.AddKhaosMetrics();
	...
	[Fact]
	public void AddKhaosMetrics_AppliesConfiguration()
	{
		var services = new ServiceCollection();
		services.AddKhaosMetrics(options => options.MaxOperationCount = 42);
