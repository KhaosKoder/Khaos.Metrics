...
Follow these short recipes to wire Khaos.Metrics into an application.
...
Run `dotnet run -c Release --project benchmarks/Khaos.Metrics.Benchmarks` to evaluate instrumentation overhead whenever you change critical code paths.
