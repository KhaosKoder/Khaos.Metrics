...
public sealed class MonitoringSnapshotProvider : IMonitoringSnapshotProvider
{
    ...
    public MonitoringSnapshotProvider(IMonitoringDataSource dataSource, ISystemClock clock)
    {
    ...
    public OperationSnapshot? GetOperationSnapshot(string name)
    {
        ...
        return CreateOperationSnapshot(snapshot, _dataSource.CurrentOptions, _clock.Now);
    }
